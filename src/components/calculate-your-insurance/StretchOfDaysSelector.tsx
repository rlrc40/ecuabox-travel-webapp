        ...
        <div className="mx-auto max-w-[380px]" ref={datepickerRef}>
          <div className="relative mb-3">
            <input
              ...
              className="h-12 w-full appearance-none rounded-lg border border-stroke pl-12 pr-4 text-dark outline-none focus:border-primary dark:border-dark-3 dark:bg-dark-2 dark:text-white"
              value={updateInput()}
